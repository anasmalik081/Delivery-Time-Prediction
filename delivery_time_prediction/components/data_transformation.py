...
from delivery_time_prediction.utils import save_object
...
class DataTransformation:
    ...
    def inititate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(filepath = self.data_transformation_config.proccessed_obj_file_path,
                     obj = fe_obj)

            save_object(filepath = self.data_transformation_config.feature_engg_obj_path,
                     obj = fe_obj)
